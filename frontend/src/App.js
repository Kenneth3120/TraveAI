...
function App() {
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ${
      ...
      {/* Enhanced Hero Section - Simplified without images */}
      <section className={`relative overflow-hidden py-20 ${
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div
            className={`absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-indigo-400 to-purple-400 rounded-full ${
          ...
          />
          <motion.div
            className={`absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-pink-400 to-indigo-400 rounded-full ${
              darkMode ? 'opacity-5' : 'opacity-10'
            }`}
            animate={{ 
              scale: [1.2, 1, 1.2],
        ...
        >
          ...
          >
            {[
              { icon: Zap, text: t('aiPowered'), color: "from-yellow-400 to-orange-500" },
              { icon: Shield, text: t('safeTravel'), color: "from-green-400 to-emerald-500" },
              { icon: Globe, text: t('localInsights'), color: "from-blue-400 to-cyan-500" },
              { icon: Target, text: t('personalized'), color: "from-purple-400 to-pink-500" }
            ].map((feature, index) => (
              <motion.div
                key={feature.text}
